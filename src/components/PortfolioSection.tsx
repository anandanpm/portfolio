...
const PortfolioSection = () => {
  ...
  const projects = [
    ...
    {
  id: 6,
  title: 'Clinic Appointment Calendar – PFact',
  category: 'web',
  description:
    'A responsive frontend-only appointment calendar built with React for clinic staff. Features include mock login, calendar views for desktop/mobile, and appointment scheduling using localStorage.',
  image: 'https://images.unsplash.com/photo-1588776814546-ec7bd03e3d8e?w=600&h=400&fit=crop',
  technologies: [
    'React.js',
    'Tailwind CSS',
    'localStorage',
  ...
  github: 'https://github.com/anandanpm/clinic_calender', // replace with actual repo URL
  live: 'https://clinic-calender.vercel.app/login', // replace with actual live URL if deployed
  featured: false,
  metrics: {
    login: 'Mock Auth',
    storage: 'localStorage',
    view: 'Calendar Responsive'
  }
}
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                <Card
                  key={index}
                  className="p-6 text-center bg-card border-border/50 hover:border-primary/50 transition-smooth"
                >
                  <div className="space-y-4">
                    <div className="mx-auto w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center">
                      <category.icon size={24} className="text-primary" />
